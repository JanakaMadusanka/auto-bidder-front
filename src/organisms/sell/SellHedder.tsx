    ...
    return (
        <div className="mb-5">
            <div className="flex justify-center items-center py-4 text-bg-gray-800">
                <p className="text-3xl font-bold">Sell My Vehicles</p>
            </div>
            <div className="grid grid-cols-4 gap-4 px-4">
                ...
                <div className="col-span-1">
                    <SellNavigation numberIcon={<TbHexagonNumber2Filled className="size-20" />} title='My Vehicles' clickNavigation={clickNavigation2 || (() => {})} />
                </div>
                <div className="col-span-1">
